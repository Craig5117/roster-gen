...
// imports validation for numbers and email
const validation = require('./Validation')

// switches questions based on employeeRole
    ...
    !!!!! Please enter the ${role}'s GitHub Username !!!!!`);
            ...
            case 'intern':
                return {
                    type: 'input',
                    name: 'school',
                    message: `What school does the ${role} attend? (You may enter N/A if not available)`,
...
// questionSwitch.prototype.managerQueries = function(employeeRole) {
